...
const TOKEN_NAME = "themiracleSol";
const TOKEN_SYMBOL = "TMC";
const TOKEN_DESCRIPTION = "A token for themiracle";
const TOKEN_IMAGE_NAME = "themiracleSol.png"; // Replace unicorn.png with your image name
const TOKEN_IMAGE_PATH = `token/bld/assets/${TOKEN_IMAGE_NAME}`;
